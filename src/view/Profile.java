...
//        dateAppointment.setDateFormatString("MMMMM d, yyyy");
                ...
                if (Desktop.isDesktopSupported()) {
                    try {
                        Desktop.getDesktop().browse(
                                new URI("http://www.google.com/search?q=" + tfMedicalCondition.getText().replaceAll(" ", "+")));
        ...
        btnSearchWikipedia.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (Desktop.isDesktopSupported()) {
                    try {
                        Desktop.getDesktop().browse(
                                new URI("https://en.wikipedia.org/w/index.php?search=" + tfMedicalCondition.getText().replaceAll(" ", "+")));
                    } catch (IOException | URISyntaxException e1) {
                        e1.printStackTrace();
                    }
                }
        ...
        btnSave.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                dl.insertGender(cbGender.getSelectedItem().toString());
                dl.insertMedicalCondition(tfMedicalCondition.getText());
                dl.insertBilling(cbBilling.getSelectedItem().toString());
