...
/**
 * <p>
 * Home is the main class of the PRMS application. It hosts a JTabel that
  ...
  public Home() {
    ...
    btnDelete.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        int reply = JOptionPane.showConfirmDialog(null, "Would you like to delete this patient?",
            ...
            if (table.getSelectedRowCount() > 0) {
              ...
              for (int i : selectedRow) {
                try {
                  ...
                  stmt.setString(1, (String) table.getModel()
                    .getValueAt(i, 0));
                  stmt.execute();
    ...
    table.addMouseListener(new MouseAdapter() {
      public void mousePressed(MouseEvent me) {
        ...
        if (me.getClickCount() == 2) {
          ...
          int patientID = Integer.parseInt(table.getValueAt(row, 0)
            .toString());
     ...
     */
    try {
      String query = "select patientID, firstname, lastname, medicalCondition, nextAppointment, phoneNumber, billing," +
        " comment from PatientInfo";
      ...
      while (rs.next()) {
        model.addRow(new String[]{rs.getString("patientID"), rs.getString("firstname"),
          rs.getString("lastname"), rs.getString("medicalCondition"), rs.getString("nextAppointment"),
          rs.getString("phoneNumber"), rs.getString("billing"), rs.getString("comment")});
      }
